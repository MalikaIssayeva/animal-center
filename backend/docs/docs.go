            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/main.Analytics"
                        }
                    },
                    "500": {
        ...
        "/animals": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Поиск по имени или породе",
                        "name": "search",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Сортировка: name_asc, name_desc, age_asc, age_desc",
                        "name": "sort",
                        "in": "query"
                    }
                ],
        ...
        "main.Analytics": {
            ...
            "properties": {
                ...
                "breedTable": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/main.BreedStat"
                    }
                },
                "modelAccuracy": {
                    "type": "integer"
                ...
                "monthlyIntake": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/main.MonthlyStat"
                    }
                },
                "needTreatment": {
                    "type": "integer"
                ...
                "typeDistribution": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/main.Distribution"
                    }
                }
            }
        },
